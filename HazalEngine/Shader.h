...
public:
	...
	void setmat3(const std::string& name, const glm::mat3* valueptr) {
		glUniformMatrix3fv(glGetUniformLocation(ID, name.c_str()), 1, false, (GLfloat*)valueptr);
	}
	void setmat4(const std::string& name, const glm::mat4* valueptr) {
		glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, false, (GLfloat*)valueptr);
	}
private:
